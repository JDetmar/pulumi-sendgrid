...
def patch_build_gradle(filepath: str) -> None:
    ...
    content = re.sub(
        r'(pom \{[^}]*?)name = ""',
        r'\1name = "Pulumi Sendgrid Provider"',
        content,
        count=1
    )
    ...
    content = content.replace(
        ...
        'url = "https://github.com/jdetmar/pulumi-sendgrid"'
    )
    content = content.replace(
        'connection = "https://example.com"',
        'connection = "scm:git:git://github.com/jdetmar/pulumi-sendgrid.git"'
    )
    content = content.replace(
        'developerConnection = "https://example.com"',
        'developerConnection = "scm:git:ssh://github.com:jdetmar/pulumi-sendgrid.git"'
    )
