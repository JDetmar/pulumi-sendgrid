...
namespace Community.Pulumi.Sendgrid
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/JDetmar/pulumi-sendgrid";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Community.Pulumi.Sendgrid.version.txt");
    ...
    internal sealed class SendgridResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public SendgridResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
